...
Главный экран VELUM — split-screen ревью анонимизации. Слева — оригинальный текст с подсветкой обнаруженных сущностей по типам, справа — анонимизированная версия с плейсхолдерами в тех же цветах. Юрист должен иметь возможность ревьюить каждую сущность (принять / отклонить / редактировать / добавить вручную).
