...
- Не помечай как PER родовые роли: "Сотрудник", "Сотрудники", "Доверитель", "Контрагент", "Кандидат", "Пользователь".
- Не помечай как LOC названия документов, общие правовые пространства и сервисы: "Положение", "Интернет", "Российская Федерация", "Федеральный закон", "Бюро".
...
- Не добавляй роли сотрудников/доверителей/контрагентов/кандидатов как PER, если нет ФИО конкретного человека.
- Не добавляй "Положение", "Интернет", "Российская Федерация", "Федеральный закон", "Бюро" как LOC.
