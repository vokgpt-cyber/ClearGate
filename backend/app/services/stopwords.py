...
LEGAL_ROLE_STOPWORDS: set[str] = {
    ...
    "лицензиар", "лицензиара", "лицензиару", "лицензиаром", "лицензиаре",
    "лицензиат", "лицензиата", "лицензиату", "лицензиатом", "лицензиате",
    "правообладатель",
    ...
    "застрахованный", "застрахованного", "застрахованному", "застрахованным", "застрахованном",
    "застрахованная", "застрахованной", "застрахованную", "застрахованные", "застрахованных",
    "страхователь", "страхователя", "страхователю", "страхователем", "страхователе",
    "страхователи", "страхователей", "страховщик", "страховщика", "страховщику",
    "страховщиком", "страховщике", "страховщики", "страховщиков",
    "страховой", "страховая", "страховое", "страховую", "страховым", "страховом", "страховые",
    "страховая компания", "страховой компании", "страховую компанию",
    "пульт", "пульта", "пульту", "пультом", "пульте",
    # Procedural roles
...
FORM_FIELD_STOPWORDS: set[str] = {
    ...
    "номер", "№", "n", "no",
    "от", "до",
    "контакт", "контакты", "контактов", "контактам", "контактами",
    "ключевые", "ключевые правила",
    "класс", "классы", "классов", "классам", "классами", "классах",
...
LOC_STOPWORDS: set[str] = {
    ...
    "федеральный медицинский", "поликлиническая", "поликлинический",
